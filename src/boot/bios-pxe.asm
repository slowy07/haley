...
VBEModeInfoBlock.XCharSize equ VBEModeInfoBlock + 22
VBEModeInfoBlock.YCharSize equ VBEModeInfoBlock + 23
VBEModeInfoBlock.NumberOfPlanes equ VBEModeInfoBlock + 24
VBEModeInfoBlock.BitsPerPixel equ VBEModeInfoBlock + 25
VBEModeInfoBlock.NumberOfBanks equ VBEModeInfoBlock + 26
VBEModeInfoBlock.MemoryModel equ VBEModeInfoBlock + 27
VBEModeInfoBlock.BankSize equ VBEModeInfoBlock + 28
VBEModeInfoBlock.NumberOfImagePages equ VBEModeInfoBlock + 29
VBEModeInfoBlock.Reserved equ VBEModeInfoBlock + 30
VBEModeInfoBlock.RedMaskSize equ VBEModeInfoBlock + 31
VBEModeInfoBlock.RedFieldPosition equ VBEModeInfoBlock + 32
VBEModeInfoBlock.GreenMaskSize equ VBEModeInfoBlock + 33
VBEModeInfoBlock.GreendFieldPosition equ VBEModeInfoBlock + 34
VBEModeInfoBlock.BlueMaskSize equ VBEModeInfoBlock + 35
VBEModeInfoBlock.BlueFieldPosition equ VBEModeInfoBlock + 36
VBEModeInfoBlock.RsvdMaskSize equ VBEModeInfoBlock + 37
VBEModeInfoBlock.RsvdFieldPosition equ VBEModeInfoBlock + 38
VBEModeInfoBlock.DirectColorModeInfo equ VBEModeInfoBlock + 39
